...
class ResourceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect(route('resources.index'))->with('success', 'Resources has been added.');
    }
    ...
    public function update(Request $request, Resource $resource)
    {
        ...
        return redirect(route('resources.index'))->with('success', 'Resource details has been updated.');
    }
    ...
    public function restore($resourceId)
    {
        ...
        return back()->with('success', 'Resource has been restored.');
    }
    ...
    public function multiple_delete(Request $request)
    {
        ...
        foreach($categories as $category){
            Resource::whereId($category)->update(['user_id' => Auth::id() ]);
            Resource::whereId($category)->delete();
        }
    ...
    public function remove_file(Request $request)
    {
        ...
        return back()->with('success', 'Resource file has been removed.');
    }
}
