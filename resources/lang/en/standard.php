...
return [
    ...
    'settings' => [
        ...
        'website' => [
            ...
            'modal_content_updates_success' => 'The Modal content setting has been updated.',
        ],
    ...
    'resources' => [
        'update_status_success' => 'Selected resource  status has been changed to :STATUS',
        'multiple_delete_success' => 'Successfully deleted the resources.',
    ],

    'resource-categories' => [
        'update_status_success' => 'Selected resource category status has been changed to :STATUS',
        'multiple_delete_success' => 'Successfully deleted the resource categories.',
    ],
