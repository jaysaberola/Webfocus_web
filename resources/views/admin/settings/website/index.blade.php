        ...
        <div class="row row-sm">
            <div class="col-lg-12">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="modalpopup-tab" data-toggle="tab" href="#modalpopup" role="tab" aria-controls="modalpopup" aria-selected="false">Modal Popup</a>
                    </li>
                </ul>
                <div class="tab-content rounded bd bd-gray-300 bd-t-0 pd-20" id="myTabContent">
                            ...
                            <form action="{{route('website-settings.update-data-privacy')}}" method="post" class="parsley-style-1" data-parsley-validate novalidate>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea required name="content" id="editor1" rows="10" cols="80">{!! old('content',$web->data_privacy_content) !!}</textarea>
                                        <span class="invalid-feedback" role="alert"><strong>The content field is required</strong></span>
                                        @error('content')
                    ...
                    <div class="tab-pane fade" id="modalpopup" role="tabpanel" aria-labelledby="modalpopup-tab">
                        <div class="col-lg-12 mg-t-15">
                            <form action="{{route('website-settings.update-modal-content')}}" method="post">
                                @csrf
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div id="title" class="parsley-input">
                                            <label>Modal Title <span class="tx-danger">*</span></label>
                                            <input type="text" name="modal_title" class="form-control" value="{{ old('modal_title',$web->modal_title) }}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="d-block">Modal Content <span class="tx-danger">*</span></label>
                                        <textarea required name="content2" id="editor1" rows="10" cols="80">{!! old('content2',$web->modal_content) !!}</textarea>
                                        <span class="invalid-feedback2" role="alert"></span>
                                        @error('content2')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                        <br>
                                        <div class="alert alert-danger" id="contentRequired2" style="display: none;">The content field is required</div>
                                    </div>

                                    <div class="form-group">
                                        <label class="d-block">Visibility</label>
                                        <div class="custom-control custom-switch @error('visibility') is-invalid @enderror">
                                            <input type="checkbox" class="custom-control-input" name="visibility" id="customSwitch1" {{ $web->modal_status == "PUBLISHED" ? "checked":"" }}>
                                            <label class="custom-control-label" id="label_visibility" for="customSwitch1">{{ucfirst(strtolower($web->modal_status))}}</label>
                                        </div>
                                    </div>
                                </div>
