...
@section('content')
                    ...
                    <div class="d-md-flex bd-highlight">
                                ...
                                <div class="dropdown-menu">
                                    <form id="filterForm" class="pd-20">
                                        <div class="form-group">
                                            ...
                                            <div class="custom-control custom-radio">
                                                <input type="radio" id="orderBy3" name="orderBy" class="custom-control-input" value="start_date" @if ($filter->orderBy == 'start_date') checked @endif>
                                                <label class="custom-control-label" for="orderBy3">Start Date</label>
                                            </div>
                                        </div>
                                        <div class="form-group">
                        ...
                        <div class="mg-t-10">
                            @if(auth()->user()->has_access_to_route('careers.create'))
                                <a class="btn btn-primary btn-sm mg-b-20" href="{{ route('careers.create') }}">Create a Career</a>
                            @endif
                        </div>
                    </div>
                </div>
    ...
    <div id="advanceSearchModal" class="modal fade" role="dialog">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <form role="form" id="advanceFilterForm" method="GET" action="{{route('careers.index.advance-search')}}">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label class="control-label">Vacant Position</label>
                            <div>
                                <input type="text" class="form-control input-sm" name="vacant_pos" value="{{ $advanceSearchData->vacant_pos }}">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div>
                                <select class="form-control input-sm" name="is_active">
                                    ...
                                    <option value="1" @if ($advanceSearchData->is_active == '1') selected @endif>Published only</option>
                                    <option value="0" @if ($advanceSearchData->is_active == '0') selected @endif>Private only</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    <label class="control-label" for="start_date1">Start Date (From)</label>
                                    <input type="date" class="form-control input-sm" id="start_date1" name="start_date1" value="{{ $advanceSearchData->start_date1 }}">
                                </div>
                                <div class="col-md-6">
                                    <label class="control-label" for="start_date2">Start Date (To)</label>
                                    <input type="date" class="form-control input-sm" id="start_date2" name="start_date2" value="{{ $advanceSearchData->start_date2 }}" min="{{ $advanceSearchData->start_date1 }}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    <label class="control-label" for="end_date1">End Date (From)</label>
                                    <input type="date" class="form-control input-sm" id="end_date1" name="end_date1" value="{{ $advanceSearchData->end_date1 }}">
                                </div>
                                <div class="col-md-6">
                                    <label class="control-label" for="end_date2">End Date (To)</label>
                                    <input type="date" class="form-control input-sm" id="end_date2" name="end_date2" value="{{ $advanceSearchData->end_date2 }}" min="{{ $advanceSearchData->end_date1 }}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="modal-footer">
                        <a class="btn btn-info" href="{{ route('careers.index') }}">Reset</a>
...
@section('pagejs')
    ...
    <script>
        ...
        let advanceListingUrl = "{{ route('careers.index.advance-search') }}";
