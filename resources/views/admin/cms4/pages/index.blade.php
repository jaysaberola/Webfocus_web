                    ...
                    <div class="table-responsive-lg">
                        <table class="table mg-b-0 table-light table-hover" style="width:100%;word-wrap: break-word;min-width:700px">
                            ...
                            @forelse($pages as $page)
                                    <?php
                                        $page_label = strlen($page->label) > 50 ? substr($page->label,0,50)."..." : $page->label;
                                        $page_name = strlen($page->name) > 50 ? substr($page->name,0,50)."..." : $page->name;
                                        $page_url = strlen($page->get_url()) > 50 ? substr($page->get_url(),0,50)."..." : $page->get_url();
                                    ?>
                                <tr id="row{{$page->id}}" class="@if($page->is_standard_page()) row_cb @endif">
                                    ...
                                    <td style="overflow: hidden;text-overflow: ellipsis;" title="{{$page->name}}">
                                        <strong @if($page->trashed()) style="text-decoration:line-through;" @endif title="{{$page->name}}"> {{$page_name}}</strong>
                                        <p class="mg-b-0 tx-gray-500 tx-11">
                                            <a target="_blank" href="{{ $page->get_url() }}">{{ $page_url }}</a>
                                        </p>
                                    </td>
