            ...
            <div>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-style1 mg-b-10">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="{{route('resources.index')}}">Resources</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Create Resources</li>
                    </ol>
                </nav>
                <h4 class="mg-b-0 tx-spacing--1">Create Resources </h4>
            </div>
        </div>
            ...
            <div class="row row-sm">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" data-role="tagsinput" name="sector" id="sector" value="{{ old('sector') }}">
                    </div>

                    <div class="form-group">
                        <label class="d-block">Type of Case</label>
                        <input type="text" class="form-control" data-role="tagsinput" name="case_type" id="case_type" value="{{ old('case_type') }}">
                    </div>
                ...
                <div class="col-lg-12 mg-t-30">
                    <input class="btn btn-primary btn-sm btn-uppercase" type="submit" value="Save Resources">
