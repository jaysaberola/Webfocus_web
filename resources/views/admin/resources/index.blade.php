    ...
    <div class="container pd-x-0">
        <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
            <div>
                ...
                <h4 class="mg-b-0 tx-spacing--1">Manage Resources</h4>
            </div>
        </div>
                    ...
                    <div class="d-md-flex bd-highlight">
                        ...
                        <div class="mg-t-10">
                            @if (auth()->user()->has_access_to_route('resource-categories.create'))
                                <a class="btn btn-primary btn-sm mg-b-10" href="{{ route('resources.create') }}">Create a Resources</a>
                            @endif
                        </div>
                    </div>
                </div>
                                        ...
                                        @else
                                            <nav class="nav table-options">
                                                ...
                                                @if (auth()->user()->has_access_to_route('resources.edit'))
                                                    <a class="nav-link" href="{{ route('resources.edit',$resource->id) }}" title="Edit Resources"><i data-feather="edit"></i></a>
                                                @endif

                                                @if (auth()->user()->has_access_to_route('resources.single.delete'))
                                                    <a class="nav-link" href="javascript:void(0)" onclick="delete_one_category({{$resource->id}},'{{$resource->name}}')" title="Delete Resource"><i data-feather="trash"></i></a>
                                                @endif
