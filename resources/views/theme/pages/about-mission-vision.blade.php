        ...
        <div class="about-hero mb-md-6">
            ...
            <div class="section-about">
                <div class="container">
                    <div class="row col-mb-50">
                        <div class="col-lg-6">
                            <h2 class="pop-animate slide-up">Our Mission</h2>
                            <p class="pop-animate slide-up stagger-1">To develop and provide customized, scalable, modular, and cost-effective Web and Mobile Application Development, Digital Marketing, Domain and Hosting, Infrastructure Installation, and Business Solutions including Managed I.T. and Professional Services.</p>
                            <p class="pop-animate slide-up stagger-2">To establish ourselves as a reliable partner of start-ups to SMEs, providing innovative solutions to specific needs.</p>
                    ...
                    <div class="row col-mb-50">
                        ...
                        <div class="col-lg-6">
                            ...
                            <p class="pop-animate slide-up stagger-1">To establish WSI as an IT and Business Solutions company that provides innovative solutions and transforms businesses to integrate technological advancements.</p>
                            <p class="pop-animate slide-up stagger-2">To be a premium and established household brand in the IT industry, offering products and services that will provide value to our customers and ensure quality and security.</p>
                        </div>
                    </div>
                </div>
            </div>
